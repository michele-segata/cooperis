...
class VEINS_API DeciderResultRms : public DeciderResult80211 {
protected:
    /** @brief Stores the gain applied by the rms TODO: transform this into an array */
    double gain;
...
public:
     ...
     */
    DeciderResultRms(bool isCorrect, double bitrate, double snr, double recvPower_dBm = 0, bool collision = false, double gain=0, double phiR=0, double thetaR=0, double phiI=0, double thetaI=0, bool reflected=false)
