 ...
 * @see DeciderRms
 */
class DeciderRms : public BaseDecider {
public:
...
protected:
    ...
    enum DeciderRms::PACKET_OK_RESULT packetOk(double snirMin, double snrMin, int lengthMPDU, double bitrate);
...
public:
     ...
     */
    DeciderRms(cComponent* owner, DeciderToPhyInterface* phy, double sensitivity, double bRate, bool ignoreNonReflectedSignals, bool ignoreNoiseAndInterference, int myIndex = -1, bool collectCollisionStatistics = false)
