...
//#define RMS_AZIMUTH_RIGHT 0
//#define RMS_AZIMUTH_CENTER (M_PI_2)
//#define RMS_AZIMUTH_LEFT (M_PI)
//#define RMS_ELEVATION_BOTTOM 0
//#define RMS_ELEVATION_MIDDLE (M_PI_2)
//#define RMS_ELEVATION_ABOVE (M_PI)

//#define RMS_AZIMUTH_RIGHT (-M_PI_2)
//#define RMS_AZIMUTH_CENTER 0
//#define RMS_AZIMUTH_LEFT M_PI_2
//#define RMS_ELEVATION_BOTTOM (-M_PI_2)
//#define RMS_ELEVATION_MIDDLE 0
//#define RMS_ELEVATION_ABOVE M_PI_2
...
public:
    ReconfigurableMetaSurface(double frequency, int n= 2);
    virtual ~ReconfigurableMetaSurface();
