...
ReconfigurableMetaSurface::ReconfigurableMetaSurface(double frequency, int n)
{
...
ReconfigurableMetaSurface::~ReconfigurableMetaSurface()
{
    gsl_matrix_free(F2);
...
void ReconfigurableMetaSurface::configureMetaSurface(double phiR_rad, double thetaR_rad, double phiI_rad, double thetaI_rad)
{
...
double ReconfigurableMetaSurface::cachedGain(double phiR_rad, double thetaR_rad) const
{
...
bool ReconfigurableMetaSurface::canUseCache(double phiI_rad, double thetaI_rad) const
{
    if (recomputeGainMap)
        return false;
...
double ReconfigurableMetaSurface::gain(double phiR_rad, double thetaR_rad, double phiI_rad, double thetaI_rad)
{
...
void ReconfigurableMetaSurface::getConfiguration(double& phiR_rad, double& thetaR_rad, double& phiI_rad, double& thetaI_rad)
{
    phiR_rad = configPhiR;
    phiI_rad = configPhiI;
...
Vector ReconfigurableMetaSurface::linspace(double min, double max, int n)
{
...
Vector ReconfigurableMetaSurface::new_vector(int n, double value)
{
...
Vector ReconfigurableMetaSurface::new_vector(Vector src)
{
...
Matrix ReconfigurableMetaSurface::matrix_from_vector(Vector v)
{
...
Matrix ReconfigurableMetaSurface::new_matrix(int rows, int columns, double value)
{
...
Matrix ReconfigurableMetaSurface::new_matrix(Matrix src)
{
...
CMatrix ReconfigurableMetaSurface::new_cmatrix(int rows, int columns, gsl_complex value)
{
...
CMatrix ReconfigurableMetaSurface::new_cmatrix(Matrix src)
{
...
void ReconfigurableMetaSurface::matrix_to_cmatrix(CMatrix dst, const Matrix src)
{
    for (int r = 0; r < src->size1; r++)
        for (int c = 0; c < src->size2; c++) {
            gsl_complex v;
...
void ReconfigurableMetaSurface::matrix_copy(Matrix dst, const Matrix src)
{
    for (int r = 0; r < src->size1; r++)
        for (int c = 0; c < src->size2; c++) {
...
void ReconfigurableMetaSurface::apply_in_place(Matrix m, double (*f)(double))
{
...
void ReconfigurableMetaSurface::abs(Vector v)
{
    for (int i = 0; i < v->size; i++)
        gsl_vector_set(v, i, std::abs(gsl_vector_get(v, i)));
}

void ReconfigurableMetaSurface::abs(Matrix m)
{
    for (int r = 0; r < m->size1; r++)
        for (int c = 0; c < m->size2; c++)
...
Matrix ReconfigurableMetaSurface::abs(CMatrix m)
{
...
int ReconfigurableMetaSurface::min_pos(Vector v)
{
    if (v->size == 0)
        return -1;
...
void ReconfigurableMetaSurface::exp(CMatrix m)
{
    for (int r = 0; r < m->size1; r++)
        for (int c = 0; c < m->size2; c++)
...
void ReconfigurableMetaSurface::print_matrix(Matrix m) {
    for (int r = 0; r < m->size1; r++) {
        for (int c = 0; c < m->size2; c++) {
...
void ReconfigurableMetaSurface::print_matrix(CMatrix m) {
    for (int r = 0; r < m->size1; r++) {
        for (int c = 0; c < m->size2; c++) {
...
void ReconfigurableMetaSurface::print_vector(Vector v) {
