...
class VEINS_API SimpleObstacleShadowingRis : public SimpleObstacleShadowing, public FrameAnalogueModel {
public:
    /**
     ...
     */
    SimpleObstacleShadowingRis(cComponent* owner, ObstacleControl& obstacleControl, bool useTorus, const Coord& playgroundSize);
